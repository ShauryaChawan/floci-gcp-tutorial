...
| Store application documents | Firestore |
| Run SQL databases | Cloud SQL |
| Run containers | Cloud Run |
| Run Kubernetes workloads | Google Kubernetes Engine (GKE) |
